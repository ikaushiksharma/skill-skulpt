...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent dark:bg-black dark:border-white/[0.4] backdrop-blur-lg bg-white/60  shadow-input flex justify-center items-center space-x-4 px-8 py-3 "
    >
      {children}
    </nav>
  );
