...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[200vh] flex flex-col items-center py-0 md:pt-60 md:pb-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-3xl font-semibold mb-20 text-center"
      >
        <span>
          Master in-demand skills. <br /> Earn what you&apos;re worth.
        </span>
      </motion.h2>
      {/* Lid */}
