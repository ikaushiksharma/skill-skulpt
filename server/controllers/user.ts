...
const EmailVerificationToken = require("../models/users/emailVerificationToken");
...
exports.create = async (req: Request, res: Response) => {
  ...
  const status = await transport.sendMail({
    from: "verification@codehaven.com",
    to: newUser.email,
...
exports.resendEmailVerificationToken = async (req: Request, res: Response) => {
  const { userId } = req.body;
...
exports.sendResetPasswordTokenStatus = (req: Request, res: Response) => {
  res.json({ valid: true });
};

exports.resetPassword = async (req: any, res: Response) => {
